      ...
      <div className="mt-gap-5">
        {projects.map((project, index) => (
          <article
            key={project.slug}
            id={project.slug}
            className="group relative -mx-gap-3 scroll-mt-gap-3 border-t border-rule px-gap-3 py-gap-4 transition-colors hover:border-ink hover:bg-surface has-[a:focus-visible]:border-ink has-[a:focus-visible]:bg-surface"
          >
