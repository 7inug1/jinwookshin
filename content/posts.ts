...
export const posts: Post[] = [
  ...
  },
  {
    ...
    date: "2026-09-06",
    summary: {
      ko: "브루탈리즘을 외형이 아니라 원리로 가져오면 무엇을 만들지 않게 되는가.",
      en: "What you end up not building when you take brutalism as a principle rather than a look.",
    },
    body: [
      p(
        "재료를 감추지 않는 편이 정직하다고 생각합니다. 브루탈리즘을 외형이 아니라 원리로 가져왔습니다. 건축에서 날 콘크리트를 감추지 않듯, 웹의 재료인 텍스트와 HTML을 감추지 않습니다.",
        "I think it is more honest not to hide the material. I took brutalism as a principle rather than a look: architecture leaves the concrete exposed, and this site leaves its material — text and HTML — exposed too.",
      ),
      p(
